...
<body>
	...
	<section id="home">
		...
		<div class="carousel carousel-slider" id="mainCarousel">
	    	...
	    	<a class="carousel-item featurePic" href="#four!"><img src="images/food_burger.jpg" class="fullViewHeight" alt="A hamburger."></a>
	    </div>
	    
	    <nav class="nav-center red darken-1" id="siteNav">
	    	<div class="nav-wrapper">
	    	<a href="#home" class="brand-logo miniLogo"><img src="images/mmm_text3.png" class="cornerLogo" alt="Logo text."></a>
 	...
 	<section id="about">
 		<div class="row">
			...
			<div class="col m10">
				<div class="row">
					<div class="col m1"></div>
	  				<div class="col m10"><img class="logo" src="images/mmm_logo.jpg" alt="Logo."></div>
	  				<div class="col m1"></div>
	  			</div>
  	...
  	<section id="alices-food">
 		<div class="row">
	  			...
	  			<div class="row">
	  				<div class="col s12 m6">
						...
						<div class="carousel carouselSlim">
					    	<a class="carousel-item" href="#one!"><img src="images/food_tacos.jpg" class="miniCarousel" alt="Tacos."></a>
					    	<a class="carousel-item" href="#two!"><img src="images/food_pizza.jpg" class="miniCarousel" alt="Pizza."></a>
					    	<a class="carousel-item" href="#three!"><img src="images/food_taquitos.jpg" class="miniCarousel" alt="Taquitos."></a>
					    	<a class="carousel-item" href="#four!"><img src="images/food_burger.jpg" class="miniCarousel" alt="A hamburger."></a>
					    	<a class="carousel-item" href="#five!"><img src="images/food_beers.jpg" class="miniCarousel" alt="Beer bottles."></a>
					    	<a class="carousel-item" href="#six!"><img src="images/food_breakfast_burrito.jpg" class="miniCarousel" alt="A breakfast burrito."></a>
					  	</div>
				  	</div>
			  		<div class="col s12 m6 ctr">
		  				<img src="images/food_menu.png" class="materialboxed menuPic" alt="Menu from Your Favorites by Alice.">
		  				<a href="images/food_menu.png" class="dlLink" download alt="Menu from Your Favorites by Alice.">Download Menu <i class="fas fa-download"></i></a>
			  		</div>
				 </div>
	  		</div>
	  		<div class="col m1"></div>
	   	...
	   	<div class="parallax-container">
	    	<div class="parallax"><img src="images/retail_taps.jpg" alt="Beer taps."></div>
	    </div>
  	</section>
  	...
  	<section id="media_awards">
		<div class="row">
			...
			<div class="col m10">
		    	...
		    	<div class="col s12 m6 l3 cardSlide">
		      		<div class="card hoverable">
		        		<div class="card-image">
		          			<img src="images/feature_green_chili_trail.jpg" class="cardPic" alt="The Green Chili Chesseburger Trail.">
		   		...
		   		<div class="col s12 m6 l3 cardSlide">
		      		<div class="card hoverable">
		        		<div class="card-image">
		          			<img src="images/feature_saveur.jpg" class="cardPic" alt="The front of Savuer magazine.">
		    	...
		    	<div class="col s12 m6 l3 cardSlide">
		      		<div class="card hoverable">
		        		<div class="card-image">
		        			<img src="images/feature_magazine.jpg" class="cardPic" alt="Michael and Alice on the front of Convenience Store News magazine.">
		    	...
		    	<div class="col s12 m6 l3 cardSlide">
		    		<div class="card hoverable">
		        		<div class="card-image">
		          			<img src="images/feature_pnmentrp.jpg" class="cardPic" alt="The front of Entrepreneurial Leadership Awards Luncheon handout.">
		...
		<div class="parallax-container">
	    	<div class="parallax"><img src="images/retail_snacks.jpg" alt="Convenience items in Michael's Mini-Mart."></div>
	    </div>
    </section>
  	...
  	<section id="locale">
  		<div class="row">
			...
			<div class="col m10">
				...
				<div class="row">
					<div class="col s12 m6 addMargin">
		  			...
		  			<div class="col s12 m6 ctr">
		  				<a class="grey-text text-lighten-4 right" href="https://www.newmexico.org/events/#events" target="_blank"><img class="nmtrue" src="images/feature_nmtrue.jpg" alt="Outdoor scenery and a New Mexico True magazine."></a>
		  				<a href="https://www.newmexico.org/events/#events" class="dlLink">Visit <span class="addBold">New Mexico True's</span> event calander! <i class="far fa-calendar-alt"></i></a>
	  				  	<div class="row">
	  				  		<img class="materialboxed col s12 m6 l4 noMargin scenery" data-caption="" width="230" src="images/state_sunset.jpg" alt="A man enjoying a New Mexico sunset.">
		  					<img class="materialboxed col s12 m6 l4 noMargin scenery" data-caption="" width="230" src="images/state_river.jpg" alt="A river within New Mexico, surrounded by lush greens and mountains.">
		  					<img class="materialboxed col s12 m6 l4 noMargin scenery" data-caption="" width="230" src="images/state_snow.jpg" alt="A man skiing in the snow, surrounded by green trees.">
	  					</div>	
		  			</div>
		  		</div>
		  	</div>
	   	...
	   	<div class="parallax-container">
			<div class="parallax"><img src="images/retail_beers.jpg" alt="Beer cases on retail shelves."></div>
		</div>
  	</section>
