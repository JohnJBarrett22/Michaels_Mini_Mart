	    	...
	    	<div class="container">
	  		...
	  		<div id="modal5" class="modal bottom-sheet">
	    		<div class="modal-content legalText">
	      			...
	      			<br>
	      			<p>Michael's Mini-Mart may diclose your personal information, without prior notice to you, only if required to do so in accordiance with applicable laws and/or in a good faith belief that such action is deemed necessary or is required in an effort to:</p>
	      			<ul>
	      				...
	      				<li>Maintain, safeguard and/or preserve all th rights and/or property of Michael's Mini-Mart; and</li>
	      			...
	      			<p>Michael's Mini-Mart does not knowingly collect personal identifiable information from children under the age of thirteen(13) wihtout verifiable parental conest. If it is determined that such information has been inadvertently collected on anyone under the age of thirteen(13), we shall immediately take the necessary steps to ensure that such information is deleted from our system's database. Anyone under the age of thirteen(13) must seek and obtain parent or guardian permission to use this website.</p>
	      			<br>
	      			<p>Unsubscribe or Opt-Out</p>
	      			<p>All users and/or visitors to our website have the option to doscontinue receiving communication from us and/or reserve the right to discontinue receiving communications by way of email or newsletters. To discontinue or unsubscribe to our website please send an email that you wish to unsubscribe to michaels.minimart@gmail.com. If you wish to unsubscribe or opt-out from any third party websites, you must go to that specific website to unsubscribe and/or opt out.</p>
	      			<br>
	      			...
	      			<br>
	      			<p>Security</p>
	      			<p>Michael's Mini-Mart shall endeavor and shall take every precaution to maintain adequate physical, procedural and technical security with respect to our offices and information storage facilities so as to prevent any loss, misuse, unathorized access, disclosure or modification of the user's personal information under our control.</p>
	      			<br>
	      			<p>Changes to Privacy Policy Agreement</p>
	      			<p>Michael's Mini-Mart reserves the right to update and/or change the terms of our privacy policy, and as such we will post those changes to our website homepage at www.michaelsminimart.com, so that our users and/or visitors are always aware of the type of information we collect, how it will be used, and under what circumstances, if any, we may diclose such information. If at any point in time Michael's Mini-Mart decided to make use of any personally identifiable information on file, in a manner vastly different from which was stated when this information was initially collected, the user or users shall be promptly notified by email. Users at that time shall have the option as to whether or not to permit the use of thier information in this separate manner.</p>
	      			<br>
	      			<p>Acceptance of Terms</p>
	      			<p>Through the use of this website, you are hereby accepting the terms and condition stipuated within the aforementioned Privacy Policy Agreement. If you are not in agreement with our terms and conditions, then you should refrain from further use of our sites. In addition, your continued use of our website following the posting of any updates and changes to our terms and conditions shall mean that you are in agreement and acceptable of such changes.</p>
	      			<br>
	      			...
	      			<br>
	      			<p>Email: michaels.minimart@gmail.com</p>
	      			<br>
	      			<p>Telephone Number: 505-852-4769</p>
	      			<br>
	      			<p>Mailing Address:</p>
	    		</div>
	    		<div class="modal-footer">
